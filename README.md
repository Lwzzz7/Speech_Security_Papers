...
- [WMCodec: End-to-End Neural Speech Codec with Deep Watermarking for Authenticity Verification](./audio_watermarking/post_hoc_watermarking/2024-WMCodec.md)  
  *IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP), 2025*  
...
- [ASSMark: Dual Defense Against Speech Synthesis Attack via Adversarial Robust Watermarking](./audio_watermarking/post_hoc_watermarking/2025-ASSMark.md)  
  *IEEE Signal Processing Letters, 2025*  
...
- [AudioMarkNet: Audio Watermarking for Deepfake Speech Detection](./audio_watermarking/post_hoc_watermarking/2025-AudioMarkNet.md)  
...
- [Audio WAtermArk: Dynamic and Harmless Watermark for Black-box Voice Dataset Copyright Protection](./audio_watermarking/post_hoc_watermarking/2025-Audio-WAtermArk.md)  
  *34th USENIX Security Symposium (USENIX Security), 2025*  
...
- [DeepAWR: An Audio Watermarking Method Against Re-recording Distortions](./audio_watermarking/post_hoc_watermarking/2025-DeepAWR.md)  
...
- [DiscreteWM: Speech Watermarking with Discrete Intermediate Representations](./audio_watermarking/post_hoc_watermarking/2025-DiscreteWM.md)  
...
- [SyncGuard: Robust Audio Watermarking Capable of Countering Desynchronization Attacks](./audio_watermarking/post_hoc_watermarking/2025-SyncGuard.md)  
...
- [VoiceMark: Zero-Shot Voice Cloning-Resistant Watermarking Approach Leveraging Speaker-Specific Latents](./audio_watermarking/post_hoc_watermarking/2025-VoiceMark.md)  
  *Annual Conference of the International Speech Communication Association (Interspeech), 2025*  
...
- [WAKE: Watermarking Audio with Key Enrichment](./audio_watermarking/post_hoc_watermarking/2025-WAKE.md)  
  *Annual Conference of the International Speech Communication Association (Interspeech), 2025*  
...
- [WaveVerify: A Novel Audio Watermarking Framework for Media Authentication and Combatting Deepfakes](./audio_watermarking/post_hoc_watermarking/2025-WaveVerify.md)  
...
- [XAttnMark: Learning Robust Audio Watermarking with Cross-Attention](./audio_watermarking/post_hoc_watermarking/2025-XAttnMark.md)  
...
- [Proactive Detection of Voice Cloning with Localized Watermarking (AudioSeal)](./audio_watermarking/post_hoc_watermarking/2024-AudioSeal.md)  
...
- [DRAW: Dual-Decoder-Based Robust Audio Watermarking Against Desynchronization and Replay Attacks](./audio_watermarking/post_hoc_watermarking/2024-DRAW.md)  
...
- [IDEAW: Robust Neural Audio Watermarking with Invertible Dual-Embedding](./audio_watermarking/post_hoc_watermarking/2024-IDEAW.md)  
...
- [MaskMark: Robust Neural Watermarking for Real and Synthetic Speech](./audio_watermarking/post_hoc_watermarking/2024-MaskMark.md)  
...
- [SilentCipher: Deep Audio Watermarking](./audio_watermarking/post_hoc_watermarking/2024-SilentCipher.md)  
  *Annual Conference of the International Speech Communication Association (Interspeech), 2024*  
...
- [An Imperceptible and Robust Audio Watermarking Algorithm Based on SNGAN](./audio_watermarking/post_hoc_watermarking/2024-SNGAN-AudioWM.md)  
...
- [Detecting Voice Cloning Attacks via Timbre Watermarking](./audio_watermarking/post_hoc_watermarking/2024-Timbre-Watermarking.md)  
...
- [Enhancing Robustness of Speech Watermarking Using a Transformer-Based Framework Exploiting Acoustic Features](./audio_watermarking/post_hoc_watermarking/2024-Transformer-Acoustic-Watermarking.md)  
...
- [AudioQR: Deep Neural Audio Watermarks for QR Code](./audio_watermarking/post_hoc_watermarking/2023-AudioQR.md)  
...
- [WavMark: Watermarking for Audio Generation](./audio_watermarking/post_hoc_watermarking/2023-WavMark.md)  
...
- [DeAR: A Deep-Learning-Based Audio Re-recording Resilient Watermarking](./audio_watermarking/post_hoc_watermarking/2023-DeAR.md)  
...
- [Robust Speech Watermarking by a Jointly Trained Embedder and Detector Using a DNN](./audio_watermarking/post_hoc_watermarking/2022-RSW-DNN.md)  
